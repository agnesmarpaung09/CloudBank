...
const produk_domain = () => {
  const kotakData = [
    { imageSrc: "images/kotak1.png", title: ".art", buttonText: "Beli", text: "Harga Mulai Dari", price : " Rp.206.000/tahun " },
    { imageSrc: "images/kotak2.png", title: ".asia", buttonText: "Beli", text: "Harga Mulai Dari", price : " Rp.233.500/tahun "},
    { imageSrc: "images/kotak3.png", title: ".com", buttonText: "Beli", text: "Harga Mulai Dari", price : " Rp.154.500/tahun " },
    { imageSrc: "images/kotak4.png", title: ".photo", buttonText: "Beli", text: "Harga Mulai Dari", price : " Rp.360.000/tahun " },
    { imageSrc: "images/kotak4.png", title: ".photo", buttonText: "Beli", text: "Harga Mulai Dari", price : " Rp.164.500/tahun " },
  ];
  ...
  {kotakData.map((item, index) => (
    <div key={index} className="h-64 w-48 relative hover:bg-white ml-3">
      <div className="relative h-full w-full flex items-center">
        <img src="images/kotak.png" alt="Kotak" className="h-full w-full" />
        <p className="absolute top-2 left-0 w-full text-center text-gray-800 font-bold text-4xl">{item.title}</p>
        <p className="absolute mt-0 left-0 w-full text-center text-gray-400 text-sm">{item.text}</p>
        <p className="absolute mt-24 left-0 w-full text-center text-blue-700 font-bold text-sm">{item.price}</p>
