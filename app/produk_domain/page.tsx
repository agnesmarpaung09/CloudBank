      ...
      <div className="text-center font-cabinet-grotesk relative  -mt-96">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center mt-8 md:mt-12">
          ...
          <div className="md:ml-0 mt- md:mt-0 text-center md:text-left">
            ...
            <div className="my-4">
              <p className="text-base text-left font-semibold text-blue-600">
                HARGA MURAH
              </p>
            ...
            <div className="my-4">
              <p className="text-base text-left font-semibold text-blue-600">
                TANPA DEPOSIT MINIMUM
              </p>
              <p className="text-xs text-justify capitalize w-[500px]">
                anda tidak perlu melakukan deposit terlebih dahulu untuk mencoba
                seluruh fitur reseller domain dikami, cukup hanya mendaftar saja
                lalu coba menjual domain.
              </p>
            </div>
            <div className="my-4">
              <p className="text-base text-left font-semibold text-blue-600">
              ...
              <p className="text-xs text-justify capitalize w-[500px]">
                tak perlu menggunakan kartu kredit atau paypal untuk melakukan
                deposit bersama kami, cukup hanya dengan transfer saja. sehingga
                tidak ada biaya tambahan dari pihak money changer.
              </p>
            </div>
            <div className="my-4">
              <p className="text-base text-left font-semibold text-blue-600">
              ...
              <p className="text-xs text-justify capitalize">
                kami siap melayani keluhan dan kritik saran anda kapanpun dan
                dimanapun.
              </p>
            </div>
            <div className="my-4">
              <p className="text-base text-left font-semibold text-blue-600">
                INTERFACE YANG MUDAH DIGUNAKAM
              </p>
              <p className="text-xs text-justify capitalize w-[500px]">
                sangat mudah untuk mengoperasikan control panel untuk memonitor
                dan mengelola client anda tanpa kesulitan.
              </p>
            </div>
          </div>
        </div>
